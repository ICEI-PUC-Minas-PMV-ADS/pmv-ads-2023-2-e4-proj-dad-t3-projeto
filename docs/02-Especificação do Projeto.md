...
| Taxa de Adesão ao Orçamento | Avaliar o quão bem os departamentos ou funcionários estão aderindo ao orçamento planejado | Gerênciamento Financeiro  | (Despesas Reais / Orçamento Planejado) x 100 | Tabela Custos | Gestor |
...
![Diagrama de Casos de Uso](img/Doc/diagrama_casos_uso_v2.svg)
...
![Gerenciamento de Tempo](img/Doc/gerenciamento_de_tempo.png)
...
![Gerenciamento de Equipe](img/Doc/gerenciamento_de_equipe.png)
